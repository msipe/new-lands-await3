...
const FACET_ABILITY_DIE_FACTORIES: Partial<Record<string, () => Die>> = {
  "facet-die-soldier-1": () => new Die({
    id: "facet-die-soldier-1", name: "Shield Bash Die", energyCost: 1,
  ...
  "facet-die-soldier-2": () => new Die({
    id: "facet-die-soldier-2", name: "Iron Guard Die", energyCost: 1,
  ...
  "facet-die-soldier-3": () => new Die({
    id: "facet-die-soldier-3", name: "Warcry I Die", energyCost: 2,
  ...
  "facet-die-soldier-4": () => new Die({
    id: "facet-die-soldier-4", name: "Shield Wall Die", energyCost: 1,
  ...
  "facet-die-soldier-5": () => new Die({
    id: "facet-die-soldier-5", name: "Battle Strike Die", energyCost: 1,
  ...
  "facet-die-soldier-6": () => new Die({
    id: "facet-die-soldier-6", name: "Warcry II Die", energyCost: 2,
  ...
  "facet-die-soldier-7": () => new Die({
    id: "facet-die-soldier-7", name: "Minor Mend Die", energyCost: 1,
  ...
  "facet-die-soldier-8": () => new Die({
    id: "facet-die-soldier-8", name: "Bulwark Die", energyCost: 1,
  ...
  "facet-die-soldier-9": () => new Die({
    id: "facet-die-soldier-9", name: "Crushing Blow Die", energyCost: 1,
  ...
  "facet-die-soldier-10": () => new Die({
    id: "facet-die-soldier-10", name: "Warcry III Die", energyCost: 2,
  ...
  "facet-die-berserker-1": () => new Die({
    id: "facet-die-berserker-1", name: "Wild Strike I Die", energyCost: 1,
  ...
  "facet-die-berserker-2": () => new Die({
    id: "facet-die-berserker-2", name: "Reckless Slash Die", energyCost: 1,
  ...
  "facet-die-berserker-3": () => new Die({
    id: "facet-die-berserker-3", name: "Wild Strike II Die", energyCost: 1,
  ...
  "facet-die-berserker-4": () => new Die({
    id: "facet-die-berserker-4", name: "Arcane Burst Die", energyCost: 1,
  ...
  "facet-die-berserker-5": () => new Die({
    id: "facet-die-berserker-5", name: "Frenzy Die", energyCost: 1,
  ...
  "facet-die-berserker-6": () => new Die({
    id: "facet-die-berserker-6", name: "Focus Up Die", energyCost: 1,
  ...
  "facet-die-berserker-7": () => new Die({
    id: "facet-die-berserker-7", name: "Wild Storm Die", energyCost: 1,
  ...
  "facet-die-berserker-8": () => new Die({
    id: "facet-die-berserker-8", name: "Scaling Strike Die", energyCost: 1,
  ...
  "facet-die-berserker-9": () => new Die({
    id: "facet-die-berserker-9", name: "Rampage Die", energyCost: 1,
  ...
  "facet-die-berserker-10": () => new Die({
    id: "facet-die-berserker-10", name: "Berserker Warcry Die", energyCost: 2,
...
function createFacetAbilityDice(progression: PlayerProgressionState): Die[] {
  return progression.unlockedFacetDieIds.flatMap((dieId) => {
    const factory = FACET_ABILITY_DIE_FACTORIES[dieId];
