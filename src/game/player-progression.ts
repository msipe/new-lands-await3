    ...
    facets: [
      ...
      },
      {
        ...
        tiers: [
          ...
          { level: 2,  name: "", description: "", abilities: [{ id: "facet:berserker:2",  dieId: "facet-die-berserker-2",  name: "Reckless Slash",   description: "Deal 3 damage — risky but powerful.",                    unlocked: false }, { id: "facet:berserker:13", dieId: "facet-die-berserker-13", name: "Bloodlust", description: "Each weapon hit this round fuels the slaughter next round.", unlocked: false }] },
